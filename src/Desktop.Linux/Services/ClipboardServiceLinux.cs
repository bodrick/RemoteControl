...
public class ClipboardServiceLinux : IClipboardService
{
    ...
    public void BeginWatching()
    {
        ...
        finally
        {
            ...
            _ = Task.Run(async () => await WatchClipboardAsync(_cancelTokenSource.Token));
        }
    }

    public async Task SetTextAsync(string clipboardText)
    {
        try
        {
    ...
    private async Task WatchClipboardAsync(CancellationToken cancelToken)
    {
