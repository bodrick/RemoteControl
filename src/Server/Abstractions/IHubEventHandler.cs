...
public interface IHubEventHandler
{
    ...
    /// <returns></returns>
    Task ChangeWindowsSessionAsync(RemoteControlSession session, string viewerConnectionId, int targetWindowsSession);
    ...
    /// <param name="viewerConnectionId"></param>
    /// <returns></returns>
    Task InvokeCtrlAltDelAsync(RemoteControlSession session, string viewerConnectionId);
    ...
    /// <returns></returns>
    Task NotifySessionChangedAsync(RemoteControlSession sessionInfo, SessionSwitchReasonEx reason, int currentSessionId);
    ...
    /// </param>
    /// <returns></returns>
    Task NotifyUnattendedSessionReadyAsync(RemoteControlSession session, string relativeAccessUrl);
    ...
    /// </param>
    /// <returns></returns>
    Task RestartScreenCasterAsync(RemoteControlSession sessionInfo, HashSet<string> viewerList);
}
