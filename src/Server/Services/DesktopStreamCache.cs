...
public interface IDesktopStreamCache
{
    ...
    Task<Result<StreamSignaler>> WaitForStreamSessionAsync(Guid streamId, TimeSpan timeout);
}
...
public class DesktopStreamCache : IDesktopStreamCache
{
    ...
    public async Task<Result<StreamSignaler>> WaitForStreamSessionAsync(Guid streamId, TimeSpan timeout)
    {
