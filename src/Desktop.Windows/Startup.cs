...
public static class Startup
{
    ...
    public static async Task<IServiceProvider> UseRemoteControlClientAsync(
        string[] args,
        ...
        string serverUri = "")
    {
        ...
        return await services.BuildRemoteControlServiceProviderAsync(args, clientConfig, AddWindowsServices, startupConfig, serverUri);
    }
